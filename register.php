...
$cpw=$_POST['cpw'];
$adm_no=$_POST['adm_no'];
$sql = "INSERT INTO passengers (p_fname, p_lname, p_age, p_contact, p_gender,adm_no, email, password) VALUES ('$fname', '$lname', '$age', '$mob', '$gender','$adm_no' ,'$email', '$pw');";
...
<HTML>
<HEAD>
<TITLE>Register on Rental Cycle System</TITLE>
...
<BODY  background="img/campus.png" link="white" alink="white" vlink="white" width="1024" height="768">
...
<TR class="left">
<TD><FONT size="5" color="WHITE">Admission Number:</FONT></TD>
<TD><INPUT name="adm_no" type="TEXT" id="adm_no" placeholder="Enter your Admission Number" size="30" maxlength="30"></TD>
</TR><tr></tr><tr></tr>
<TR class="left">
