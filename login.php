...
if (isset($_POST['submit'])) {
	...
	if (!empty($user)) {
		...
		echo 'window.location.href = "http://localhost/Rental%20Cycle%20System/booktkt.php";';
		echo '</script>';
	} else {
...
<body>
	...
	<div id="loginarea">
		<form id="login" action="login.php" onsubmit="return validate()" method="post" name="login">
			<div id="logintext">Login to Rental Cycle System!</div><br /><br />
			<table>
				<tr>
					<td>
						<div class="data">Enter E-Mail ID:</div>
					</td>
